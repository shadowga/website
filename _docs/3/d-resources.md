...
You can directly access the online file transfer server by manually entering address and port (`b.shadow.ga:27579`) or by clicking [here](http://b.shadow.ga:27579).
