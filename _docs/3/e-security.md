...
> **Note:** As of now, Discord's process of enabling 2FA is only present on the web and desktop versions of their programme. You'll need a desktop machine for this, but it only needs to be done once.
