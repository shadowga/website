---
layout: docs
title: 3d. Member management
permalink: /docs/3/d-membermanage/
---
Administrators are capable of muting, kicking, and banning members on the server when they're breaking policy.
It's important to master these tools so you can effectively handle the server.
...
TotalFreedomMod commands, usages, and purposes can be viewed over HTTPD.

### Kicking members
There are multiple commands for kicking 
